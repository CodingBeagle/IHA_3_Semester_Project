...
\subsection{GitHub}
Til projektet var det vigtigt at have en centraliseret server til alle projektets dokumenter samt kode, som alle medlemmer kunne tilgå og redigere i på samme tid. Det var også af stor betydning at der blev holdt en automatisk versionshistorik for alle filer, så alle ændringer gemmes. Til dette brugte vi versionsstyrings softwaret \textit{Git}, via \textit{GitHub}. GitHub er en web-baseret løsning der gratis stiller en Git server til rådighed, samt en brugergrænseflade for at kunne tilgå de uploadede filer.

På figur \ref{ref:GitHubHistorik} ses et udsnit af en versionshistorik for et af projektets filer. 

\begin{figure}[H]
	\centering
	\includegraphics[scale=1.0]{Projektgennemfoerelse/images/GitHubHistorik}
