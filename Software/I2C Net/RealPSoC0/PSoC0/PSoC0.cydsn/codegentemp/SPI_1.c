...
static void SPI_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[SPI_1_RX_SCL_MOSI_PIN_INDEX] = SPI_1_HSIOM_I2C_SEL;
            hsiomSel[SPI_1_TX_SDA_MISO_PIN_INDEX] = SPI_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[SPI_1_RX_SCL_MOSI_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
            hsiomSel[SPI_1_TX_SDA_MISO_PIN_INDEX] = SPI_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[SPI_1_TX_SDA_MISO_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                pinsDm  [SPI_1_TX_SDA_MISO_PIN_INDEX] = SPI_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[SPI_1_RX_SCL_MOSI_PIN_INDEX] = SPI_1_HSIOM_UART_SEL;
                    pinsDm  [SPI_1_RX_SCL_MOSI_PIN_INDEX] = SPI_1_PIN_DM_DIG_HIZ;
                }
