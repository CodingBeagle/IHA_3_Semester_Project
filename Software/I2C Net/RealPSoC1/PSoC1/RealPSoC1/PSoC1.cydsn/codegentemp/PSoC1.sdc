...
# Date: Wed, 18 May 2016 08:12:21 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_PWM_1} -source [get_pins {ClockBlock/hfclk}] -edges {1 1201 2401} [list [get_pins {ClockBlock/udb_div_0}]]
