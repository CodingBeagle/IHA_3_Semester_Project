...
module ADC_SAR_SEQ_P4_v2_30_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("35597184-8ab6-418a-99f5-e6af2273f511/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("35597184-8ab6-418a-99f5-e6af2273f511/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("72df9021-4826-4df3-a323-c0d9f12830a7"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("50000000000"),
		  .is_direct(0),
