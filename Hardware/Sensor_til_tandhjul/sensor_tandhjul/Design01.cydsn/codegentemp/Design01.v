...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=Opamp_1, )
...
module ADC_SAR_SEQ_P4_v2_30_2 (
	...
	cy_clock_v1_0
		#(.id("2ebfbff1-c644-4fa9-b1f7-c5541147a757/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__opamp_m_net;
	wire [0:0] tmpFB_0__opamp_m_net;
	wire [0:0] tmpIO_0__opamp_m_net;
	wire [0:0] tmpINTERRUPT_0__opamp_m_net;
	electrical [0:0] tmpSIOVREF__opamp_m_net;
	...
	cy_psoc3_pins_v1_10
		...
		opamp_m
		 (.oe(tmpOE__opamp_m_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__opamp_m_net[0:0]}),
		  .analog({Net_565}),
		  .io({tmpIO_0__opamp_m_net[0:0]}),
		  .siovref(tmpSIOVREF__opamp_m_net),
		  .interrupt({tmpINTERRUPT_0__opamp_m_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__opamp_m_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_led_out_net;
	wire [0:0] tmpFB_0__PWM_led_out_net;
	wire [0:0] tmpIO_0__PWM_led_out_net;
	wire [0:0] tmpINTERRUPT_0__PWM_led_out_net;
	electrical [0:0] tmpSIOVREF__PWM_led_out_net;

	cy_psoc3_pins_v1_10
		#(.id("4a3b8127-9275-4a33-9017-39e3157948ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_led_out
		 (.oe(tmpOE__PWM_led_out_net),
		  .y({Net_381}),
		  .fb({tmpFB_0__PWM_led_out_net[0:0]}),
		  .io({tmpIO_0__PWM_led_out_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_led_out_net),
		  .interrupt({tmpINTERRUPT_0__PWM_led_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_led_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__opamp_p_net;
	wire [0:0] tmpFB_0__opamp_p_net;
	wire [0:0] tmpIO_0__opamp_p_net;
	wire [0:0] tmpINTERRUPT_0__opamp_p_net;
	electrical [0:0] tmpSIOVREF__opamp_p_net;

	cy_psoc3_pins_v1_10
		#(.id("4c87a52a-adea-42d7-85a5-532e364d26cf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		opamp_p
		 (.oe(tmpOE__opamp_p_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__opamp_p_net[0:0]}),
		  .analog({Net_276}),
		  .io({tmpIO_0__opamp_p_net[0:0]}),
		  .siovref(tmpSIOVREF__opamp_p_net),
		  .interrupt({tmpINTERRUPT_0__opamp_p_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__opamp_p_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("ca74099d-1e93-46b1-a525-b708289490c8"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("400000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fbf83255-eb47-4910-92de-7235c6bc1a8c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__isr_in_net;
	wire [0:0] tmpIO_0__isr_in_net;
	wire [0:0] tmpINTERRUPT_0__isr_in_net;
	electrical [0:0] tmpSIOVREF__isr_in_net;

	cy_psoc3_pins_v1_10
		#(.id("1396d150-05dd-4caf-8cd1-84a5e82d17c4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		isr_in
		 (.oe(tmpOE__isr_in_net),
		  .y({1'b0}),
		  .fb({Net_1611}),
		  .io({tmpIO_0__isr_in_net[0:0]}),
		  .siovref(tmpSIOVREF__isr_in_net),
		  .interrupt({tmpINTERRUPT_0__isr_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__isr_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("13fa7079-1fb9-4456-98ee-565401c3ac35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PWM_motor_out_net;
	wire [0:0] tmpFB_0__PWM_motor_out_net;
	wire [0:0] tmpIO_0__PWM_motor_out_net;
	wire [0:0] tmpINTERRUPT_0__PWM_motor_out_net;
	electrical [0:0] tmpSIOVREF__PWM_motor_out_net;

	cy_psoc3_pins_v1_10
		#(.id("b6b7d940-79c4-46ef-bce3-99daa10b4eae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_motor_out
		 (.oe(tmpOE__PWM_motor_out_net),
		  .y({Net_1976}),
		  .fb({tmpFB_0__PWM_motor_out_net[0:0]}),
		  .io({tmpIO_0__PWM_motor_out_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_motor_out_net),
		  .interrupt({tmpINTERRUPT_0__PWM_motor_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_motor_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
