...
På figur \ref{fig:ibdDiagram} vises alle hardwareblokke med de fysiske forbindelser beskrevet i BDD'et (figur \ref{figure:bddDiagram}). 
...
I tabel \ref{table:signalbeskrivelse} ses beskrivelser af alle signaler i systemet. For uddybende IBD'er over motorstyring og affyringsmekanisme ses \#ref{dokumentation, systemarkitektur, IBD'er}. 
