...
\section{Software}
Til produktet er der udviklet software til CPU'erne præsenteret i Software Allokering, afsnit \ref{afsnit:SoftwareAllokering}, figur \ref*{figure:allocationDiagram}.
...
Use Case 2 beskriver test af systemet før spillet startes. På figur \ref{fig:SystemTestSekvensDiagram} vises test sekvensen. Det ses her at 
