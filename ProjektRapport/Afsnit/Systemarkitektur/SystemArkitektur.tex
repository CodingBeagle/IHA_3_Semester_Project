...
\section{Software}
Softwaren til systemet er udarbejdet for hver CPU (se evt. software allokeringsdiagrammet på side \pageref{figure:allocationDiagram} figur \ref{figure:allocationDiagram}) ud fra en applikationsmodel, der kan ses i dokumentationen side (\textbf{Indsæt reference til applikationsmodel dokumentations \#ref}). Ud fra disse applikationsmodeller er der udarbejdet klassediagrammer, der viser software klasserne på den givne CPU, samt deres relationer til hinanden.
...
\begin{figure}[H]
	\centering
	\includegraphics[]{SystemArkitektur/images/klassediagramPSoC0}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{llll}
			...
			I2C\_FAIL                                                         & Signalerer I2C-testen fejlede           & 1100 0010                        & 0xC2                           \\
			\rowcolor[HTML]{CBCEFB} 
