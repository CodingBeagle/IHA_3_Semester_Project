...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		MotorControl                   & \begin{tabular}[c]{@{}l@{}}MotorControl blokken er Candy Gun 3000’s motorerer, der anvendes \\ til at bevægekanonen i forskellige retninger.Denne blok består af Hbro blok og rotationsbegrænsnings blokken \end{tabular} \\ \hline
		Motor &
		\begin{tabular}[c]{@{}l@{}}blokken er selv motoren  \end{tabular} \\ \hline
		H bro &
		\begin{tabular}[c]{@{}l@{}}blokken er vores h bro som bruges til at få mototren til at køre i begge retninger (glæder for begge h bro blokke)  \end{tabular} \\ \hline
			rorationsbegrænsing &
			\begin{tabular}[c]{@{}l@{}}blokken er til at styre at motoren ikke drejer 360 grader. Den består af potentiometer og ADC'en som sidder på PSoC'en (glæder for begge rotationsbegrænsning blokke) \end{tabular} \\ \hline
