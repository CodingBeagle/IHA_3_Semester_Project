...
\section{Software}
Softwaren til systemet er udarbejdet for hver CPU (se evt. software allokeringsdiagrammet på side \pageref{figure:allocationDiagram} figur \ref{figure:allocationDiagram}) ud fra en applikationsmodel, der kan ses i dokumentationen side (\textbf{Indsæt reference til applikationsmodel dokumentations \#ref}). Ud fra disse applikationsmodeller er der udarbejdet klassediagrammer, der viser software klasserne på den givne CPU, samt klassernes relationer til hinanden. Forslag til klassediagrammer for hver CPU i systemet kan ses på figur \ref{figure:initialKlassediagramDevkit}, \ref{figure:initialKlassediagramPSoC0} og \ref{figure:initialKlassediagramPSoC1}.
