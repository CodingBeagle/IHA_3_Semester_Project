...
\subsubsection{H-bro}
H-broen er en del af ”motorControl” blokken, hvor den har til opgave at styre motoren, så den både kan køre til højre og venstre. Der blev valgt i denne projekt at bygge en h-broen op fra bunden selv. Selvom man kunne få en komponeret som indholdet en h-bro, som man sagtes kunne bruges, men den blev valgt fra, for selv at få en bedre ide om hvordan h-broen er bygget op og hvordan den funger.  
\begin{figure}[H]
	\begin{adjustwidth}{-3cm}{-\rightmargin}
		\centering
		\includegraphics[width=0.4\paperwidth]{Afsnit/DesignOgImplementering/images/hbro}
		\caption{færdig H-bro}
		\label{fig:hbro}
	\end{adjustwidth}
\end{figure}


For at få motoren til fx at køre til højre, skal P mosfet og N mosfet åbnes. For at N mosfet’en skal åbne, skal der et positiv spændingen til. Imens for at P mosfet’en kan åbne, skal den have en negativ spænding på gatebenet for at kunne åbne. For at løse dette blev der sat en N mosfet, foran hver af P mosfet, for at trække spændingen ned, så P mosfet’ene kan åbne. \\
...
\\
Resten af komponenterne bliver beskrevet over i dokumentationen ref.
