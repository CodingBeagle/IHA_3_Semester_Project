...
\subsubsection{H-bro}
H-broen er en del af ”motorControl” blokken, hvor den har til opgave at styre motoren, så den både kan køre til højre og venstre. Der blev valgt i dette projekt at bygge en h-broen op fra bunden selv. Selvom man kunne få en komponeret som indholdet en h-bro, som man sagtes kunne bruges, men den blev valgt fra, for selv at få en bedre ide om hvordan h-broen er bygget op og hvordan den fungerer.  

\begin{figure}[H]
	\begin{adjustwidth}{-3cm}{-\rightmargin}
		\centering
		\includegraphics[width=0.4\paperwidth]{Afsnit/DesignOgImplementering/images/H-bro}
