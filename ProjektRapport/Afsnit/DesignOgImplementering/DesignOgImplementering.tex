...
I \ref{hbrotabel} ses relevante komponentværdier for H-broen. En fyldestgørende oversigt over disse ses i \ref{dokumentationen}
...
Når motoren skal køre fremad, skal Q9 og Q4 åbnes. For at N-MOSFET'en (Q4) kan åbne, skal der en positiv spænding ind på gatebenet. For at P-MOSFET'en (Q9) kan åbne, skal den have en negativ spænding. For at løse dette blev der sat en N mosfet, foran hver af P mosfet, for at trække spændingen ned, så P mosfet’ene kan åbne. \\

%For at få motoren til for eksempel at køre til højre, skal P mosfet og N mosfet åbnes. For at N mosfet’en skal åbne, skal der et positiv spændingen til. Imens for at P mosfet’en kan åbne, skal den have en negativ spænding på gatebenet for at kunne åbne. For at løse dette blev der sat en N mosfet, foran hver af P mosfet, for at trække spændingen ned, så P mosfet’ene kan åbne. \\

Da motoren gerne skal kunne skifte retning hurtigt og ofte, er det nødvendigt, at de to MOSFET's kan både åbne og lukke hurtigt. På figur \ref{fig:mof} ses, hvordan Q9 åbner og lukke langsomt, i forhold til hvad der var ønsket for projektet, dette skyldes kondensator effekt i mellem benene på mosfet'ene.
Derfor blev Q5 indsat, for at mosfet'en kan åbne hurtigere. Der var stadig det problem, at Q9 var langsom til at lukke, og derfor blev Q6 sat ind. På figur \ref{fig:moe} ses, hvordan driveren gør, at Q9 både åbner og lukker hurtigt. \\
...
%Da der ønskes at kunne skifte motorens retning hurtigt og ofte, var det nødvendigt at indsætte en transistor foran hver P-MOSFET
%Da der i dette projekt ønskes at skifte retning ofte, blev der sat foran hver P mosfet, to transistorer, for at hurtig at kunne aflade og oplade mosfet’ene, på grund af kondensator effekt i mellem benene ville det tag længere tid at åbne og lukke for mosfet’en, så derfor blev det valgt at sætte transistorer ind. Selvom der findes en komponent (IRF2101), som kan hjælpe med dette, men der blev valgt at bruge transistorer, for at få en bedre ide om hvordan det hele funger. Som man kan se på figur\ref{fig:mof} viser hvordan det så ud før at transistorer var sat ind. På figur \ref{fig:moe} viser det  hvordan det ser ud efter at transistorerne er sat ind. Så det gør som forvente at mosfet’ene åbne og lukker hurtigere. \\

\begin{figure}[H]
	\begin{adjustwidth}{-3cm}{-\rightmargin}
		\centering
		\includegraphics[width=0.3\paperwidth]{Afsnit/DesignOgImplementering/images/mof}
		\caption{før transistorer blev sat ind}
		\label{fig:mof}
	\end{adjustwidth}
\end{figure}
...
\begin{figure}[H]
	\begin{adjustwidth}{-3cm}{-\rightmargin}
		...
		\caption{efter transistorer blev sat ind}
		\label{fig:moe}
	\end{adjustwidth}
\end{figure}

Der er også blevet sat diode fire ind i kredsløbet, de fire dioder skal fungere som beskyttelse af mosfet’ene, Det de gør, er at de sikrer at den spænding, som er tilbage i motoren, når man lukker for mosfetene, ikke løber tilbage ind i mosfetene og brænder dem af.
\\
Resten af komponenterne bliver beskrevet over i dokumentationen \ref{dokumentation, h-bro}.
...
Nunchuck klassen er seperat fra I2CCommunication klassen, idét at Nunchucken bruger sin egen kommunikationsprotokol, som defineret i \#ref \textbf{Reference til nunchuck i bilag}. Fra systemarkitekturen figur \ref{fig:CompleteClassDiagramPSoC0} og \ref{fig:CompleteClassDiagramPSoC1}, er det udledt at softwaren skal have metoder til at skrive og læse fra nunchucken. På figur \ref{figure:NunchuckKlassediagram} ses klassediagrammet for den implementerede nunchuck klasse, der indeholder metoder der har disse funktionaliteter.
