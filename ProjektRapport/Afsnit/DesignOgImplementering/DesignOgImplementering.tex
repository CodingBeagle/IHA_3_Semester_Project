...
Til at styre affyringsmekanismens motor er der bygget et kredsløb med en MOSFET som primære komponent. MOSFET'en skal sørge for, at motoren kun kører, når der bliver sendt PWM-signal ind på gatebenet. Kredsløbsdiagrammet kan ses på figur \ref{fig:affyringsmotor}. 
...
Når der sendes PWM-signal ind på MOSFET'ens gateben vil motorens hastighed kunne styres ved hjælp af PWM-signalets dutycycle. Der er valgt en meget lav dutycycle. Grunden til dette er, at motoren ikke må køre så hurtigt, at den ikke kan nå at stoppe igen inden den har kørt en omgang mere. Dette kunne være afhjulpet med en bremsefunktion, men den er ikke implementeret. 

Der sidder to dioder i kredsløbet. Disse er begge sat ind for at beskytte henholdsvis motoren og MOSFET'en. Dioden D1 er sat ind for at sikre motoren mod store spændingsspikes, der kan forekomme, når MOSFET'en bliver afbrudt. Dioden D2, der sidder fra source til drain, sikrer, at spikes genereret af motoren, når den slukkes, ikke brænder MOSFET'en af. 
