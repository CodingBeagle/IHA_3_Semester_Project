...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{l|l|l|l|l}
			\textbf{Kommandotype} & \textbf{Beskrivelse} & \textbf{Binær Værdi} & \textbf{Hex Værdi} & \multicolumn{1}{l|}{\textbf{Data Bytes}} \\ \hline
			NunchuckData & \begin{tabular}[c]{@{}l@{}}Indeholder aflæst input data\\ fra Wii-Nunchuck Controlleren\end{tabular} & 00101010 & 2A & \begin{tabular}[c]{@{}l@{}}Byte \#1:\\ Analog Stick Y værdi\\ \\ Byte \#2:\\ Analog stick X værdi\\ \\ Byte \#3:\\ Knap tryk\end{tabular} \\
			&  &  &  &  \\
			&  &  &  &  \\ \hline
		\end{tabular}%
	}
	\caption{I2C Protokol Kommandotyper}
