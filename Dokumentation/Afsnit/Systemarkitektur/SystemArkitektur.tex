...
\noindent \textbf{PSoC2} \par
\noindent \textit{PSoC2} denne blok står for at sende et signal til affyringsmekanismen om at den skal skyde og så skal den også holde styre på at der kun bliver skydt en gang.

\noindent \textbf{Projectile Launcher} \par
\noindent \textit{Projectile Launcher} den blok er vores affyringsmekanismen

\noindent \textbf{MotorControl} \par
\noindent \textit{MotorControl} blokken er Candy Gun 3000's motorerer, der anvendes til at bevæge kanonen i forskellige retninger. Denne blok består af Hbro blok og rotationsbegrænsnings blokken

\noindent \textbf{Motor} \par
\noindent \textit{Motor} blokken er selv motoren 

\noindent \textbf{Hbro} \par
\noindent \textit{Hbro} blokken er vores h bro som bruges til at få mototren til at køre i begge retninger (glæder for begge h bro blokke)

\noindent \textbf{rotationsbegrænsning} \par
\noindent \textit{rotationsbegrænsning} blokken er til at styre at motoren ikke drejer 360 grader. Den består af potentiometer og ADC'en som sidder på PSoC'en (glæder for begge rotationsbegrænsning blokke)
