...
\section{Integration}
For at verificere at systemet fungerer når det sammensættes til en enkelt enhed, er der lavet en integrationstest. Testen er lavet ud fra et 'black-box' princip, hvilket vil sige, at der kun evalueres ud fra systemets funktionalitet, og ikke på de interne struktur.
Testen udføres ved, at klikke på 'Start-test', og bagefter observere udskrivningen på terminal-vinduet på brugergrænsefladen. 

\begin{figure}[H]
	\includegraphics[width=\textwidth]{Test/images/SPItest/SPIModulTestOpsaetning2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Test/images/SPItest/SPIModulTestTerminal}
	\caption{Output fra integrationstesten}
