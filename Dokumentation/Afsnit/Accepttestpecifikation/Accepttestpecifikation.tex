...
\begin{tabular}{|>{\hspace{0pt}}p{0.6cm} |  >{\hspace{0pt}}p{3.5cm} | >{\hspace{0pt}}p{2.5cm} | p{2.5cm} | p{2cm} |}
	...
	%6 & Kig på brugergrænsefladen. & Brugergrænsefladen viser info om spillet. & & \\ \hline
...
\begin{tabular}{|>{\hspace{0pt}}p{0.6cm} |  >{\hspace{0pt}}p{3.5cm} | >{\hspace{0pt}}p{2.5cm} | p{2.5cm} | p{2cm} |}
	...
	3 & Mål kanonens dimensioner med en lineal. & Dimensionerne overstiger ikke 50cm x 50cm x 50cm. & & \\ \hline
