...
\begin{math}
	f_{H}=fraq{1}/{2\pi R_{H} C_{H}}=fraq{1}{2\pi \cdot 10k\Omega \cdot 1\mu F}=15,9Hz
\end{math} \\

Og lavpasfilterets afskæringsfrekvens er beregnet på følgende måde: \\

\begin{math}
	f_{L}=fraq{1}/{2\pi R_{L} C_{L}}=fraq{1}{2\pi \cdot 510k\Omega \cdot 10pF}=15,9Hz
\end{math} \\
...
\begin{equation}
	U_{O}=(1+\frac{10k\Omega}{10k\Omega}) \cdot 2V
\end{equation}
