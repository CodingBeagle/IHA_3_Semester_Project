...
\subsubsection{Nunchuck Data Flow Algoritme}

\begin{figure}[H]
	\begin{adjustwidth}{-2cm}{-\rightmargin}	
		\centering
		\includegraphics[width=0.75\paperwidth]{DesignOgImplementering/images/nunchuckFlowActivity}
		\caption{Aktivitetsdiagram som viser overføring af Nunchuck data til PSoC1}
		\label{figure:NunchuckFlowActivity}
	\end{adjustwidth}
\end{figure}
