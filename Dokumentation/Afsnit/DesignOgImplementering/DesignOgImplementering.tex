...
\begin{itemize}
\item MOSFET N-kanal\\
	Den kan klare en strøm på 30A (tjek lige med en anden) ifølge databladet. Det vil altså ikke komme til at påvirke motoren, som kan trække en strøm på 0,35A. 
	...
	\begin{figure}[H]
		...
		\caption{Gate-to-Source Voltage}
	\end{figure}
...
\item MOSFET P-kanal \\
	Det er valgt at bruge en P-MOSFET af typen IRF9Z34N. Denne kan trække en strøm på 6,7A ifølge databladet. Det vil altså ikke komme til at påvirke motoren, da den kan trække en strøm på 0,35A. 
